...
export const SUBJECTS: Subject[] = [
  {
    slug: "gcse",
    title: "GCSE",
    heading: "Online GCSE Maths and Science tutoring",
    metaTitle: "GCSE Maths & Science Tutor Online | Preethi Amudhan",
    metaDescription:
      "One-to-one online GCSE tutoring in Maths, Biology, Chemistry, Physics and Combined Science for AQA, Edexcel and OCR. Grade 9 tutor, £30 an hour, book online.",
    keywords: ["GCSE tutor", "GCSE maths tutor online", "GCSE science tutor", "GCSE chemistry tutor", "GCSE biology tutor", "GCSE physics tutor", "Norwich GCSE tutor"],
    serviceId: "gcse-60",
    motif: "graph",
    ...
    lead:
      "One-to-one GCSE sessions in Maths, Biology, Chemistry, Physics and Combined Science, planned around your exam board and the grade you are aiming for. Taught online by a final-year medical student who got grade 9s in the sciences herself.",
    covers: [
      ...
      { title: "Exam technique", text: "Command words, mark schemes, the six-mark extended answers in science and the show-your-working habits that examiners reward in maths." },
      { title: "Required practicals and maths skills", text: "The practical questions students skip in revision, and the rearranging, units and graph skills that sit under every science paper." },
    ...
    whoFor: [
      "Year 10 and 11 students aiming for grades 7 to 9",
      "Students who understand the classwork but lose marks under exam conditions",
      "Anyone on AQA, Edexcel or OCR, Combined or Separate Science",
    ...
    faqs: [
      { q: "Which GCSE subjects do you tutor?", a: "Maths, Biology, Chemistry, Physics and Combined Science. If a student takes two of these, sessions can alternate or be split." },
      { q: "Do you cover my exam board?", a: "Yes. AQA, Edexcel and OCR for both Maths and the sciences. Tell me the board and tier at booking and I will plan from that specification." },
  ...
  },
  {
    ...
    lead:
      "A-level Biology, Chemistry and Maths, taught one-to-one by someone who got an A in all three at Sir Isaac Newton Sixth Form and then went on to study Medicine. Sessions are planned around your specification, your predicted grade and the grade you actually need.",
    covers: [
      { title: "The hard topics, properly", text: "Organic mechanisms, equilibria and buffers, genetics and gene technologies, integration and mechanics: the topics that decide grades, explained from first principles." },
      ...
      { title: "Practical skills and data", text: "Required practicals, uncertainty, and the graph and data questions that appear in every paper." },
    ],
    whoFor: [
      ...
      "Students on AQA, Edexcel or OCR (including OCR A and Salters B in Chemistry)",
      "Anyone applying for medicine, dentistry or biomedical courses who needs strong science grades",
    ],
    approach: [
      "I sat these exams recently and now use the same content every week in medical school, so I can explain why a topic matters as well as how to answer questions on it.",
    ...
    faqs: [
      { q: "Which A-level subjects do you tutor?", a: "Biology, Chemistry and Maths. I do not currently offer Physics or Further Maths." },
