  ...
  return (
    <section aria-labelledby="hero-title" className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="bg-dots mask-fade absolute inset-x-0 top-0 h-[42rem]" />
        <div className="absolute -right-40 -top-56 h-[36rem] w-[36rem] rounded-full bg-[radial-gradient(closest-side,rgb(174_214_204/0.55),transparent)]" />
        <div className="absolute -left-48 top-[28rem] h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(closest-side,rgb(253_235_221/0.9),transparent)]" />
      </div>
    ...
    <section id="about" aria-labelledby="about-title" className="section scroll-mt-24">
      <div className="container-x grid gap-12 lg:grid-cols-[minmax(0,1fr)_22rem] lg:gap-16">
        ...
        <aside aria-label="At a glance" className="card overflow-hidden self-start lg:sticky lg:top-24">
          <div className="surface-dark bg-dots-dark relative p-6">
  ...
  return (
    <section id="pricing" aria-labelledby="pricing-title" className="section scroll-mt-24">
      <div className="container-x section-grid">
        ...
        {intro && (
          <div className="card flex flex-col gap-5 border-pine-200 bg-gradient-to-r from-pine-50 to-white p-6 sm:flex-row sm:items-center sm:justify-between sm:p-7">
...
export function FaqList({ items }: { items: { q: string; a: string }[] }) {
  return (
    <div className="grid gap-3">
      {items.map((f) => (
        <details key={f.q} className="card group !rounded-2xl open:border-pine-200">
          <summary className="focus-ring flex cursor-pointer list-none items-center justify-between gap-4 rounded-2xl px-5 py-4 text-left font-medium text-pine-900 hover:bg-cream-50 [&::-webkit-details-marker]:hidden">
            {f.q}
  ...
  return (
    <section aria-labelledby="cta-title" className="section !border-t-0 !pt-0">
      <div className="container-x">
        <div className="surface-dark relative overflow-hidden rounded-[1.75rem] px-7 py-14 sm:px-14 sm:py-16">
          <div className="bg-dots-dark mask-fade absolute inset-0" aria-hidden />
          <svg aria-hidden viewBox="0 0 400 400" className="absolute -right-20 -top-24 h-[28rem] w-[28rem] text-white/10" fill="none" stroke="currentColor" strokeWidth="1.5">
