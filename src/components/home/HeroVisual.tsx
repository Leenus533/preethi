...
export function HeroVisual({ className = "" }: { className?: string }) {
  return (
    <div className={`relative ${className}`} aria-hidden="true">
      <div className="relative aspect-square overflow-hidden rounded-[1.75rem] border border-cream-300 bg-gradient-to-br from-pine-50 via-cream-50 to-cream-100 shadow-[var(--shadow-card)] lg:aspect-[4/5]">
        ...
        <svg viewBox="0 0 100 100" className="drift absolute right-[9%] top-[4%] w-[20%] text-pine-700 lg:w-[22%] lg:top-[5%]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinejoin="round">
        ...
        {/* DNA helix, left edge. */}
        <svg viewBox="0 0 100 200" className="drift drift-slow absolute left-[6%] top-[7%] h-[44%] text-pine-500" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round">
        ...
        <div className="rise rise-2 absolute right-[6%] top-[29%] w-[62%] max-w-[17rem] lg:top-[36%]">
          <div className="rounded-2xl border border-cream-300 bg-white p-4 shadow-[var(--shadow-lift)]">
          ...
          <div className="rise rise-3 absolute -right-3 -top-5 rotate-6 rounded-xl border border-clay-200 bg-clay-100 px-3 py-2 shadow-[var(--shadow-soft)]">
