  ...
  return (
    <div className="container-x py-12 sm:py-16">
      <article className="mx-auto max-w-2xl">
        ...
        <h1 className="font-display mt-2 text-3xl text-pine-900 sm:text-4xl">Privacy notice</h1>
        ...
        <div className="mt-8 space-y-6 text-ink-soft leading-relaxed">
          <section>
            <h2 className="font-display text-xl text-pine-900">What we collect</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl text-pine-900">How it is used</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-pine-900">Who it is shared with</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl text-pine-900">How long it is kept</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl text-pine-900">Your rights and contact</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-xl text-pine-900">Cookies</h2>
