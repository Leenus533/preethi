  ...
  return (
    <div className="container-x py-12 sm:py-16">
      <article className="mx-auto max-w-[var(--measure)]">
        <h1 className="font-display font-display-lg text-[length:var(--text-h2)] leading-[1.12] text-pine-900">Terms and cancellation policy</h1>
        ...
        <div className="mt-8 space-y-6 text-ink-soft leading-relaxed">
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">1. Who you are booking with</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">2. Booking and payment</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">3. Rescheduling and cancellation</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">4. Your right to cancel and refunds</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">5. Sessions</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">6. Safeguarding</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">7. Results</h2>
            <p className="mt-2">Tutoring supports learning but no particular grade or admissions outcome can be guaranteed.</p>
          </section>
          <section>
            <h2 className="font-display text-[length:var(--text-h3)] text-pine-900">8. Complaints and governing law</h2>
            <p className="mt-2">
